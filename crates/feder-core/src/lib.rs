...
mod tests {
    ...
    #[test]
    fn decide_received_follow_accepts_new_follower() {
        let core = core();
        ...
        let StateChange::StoreActivity {
            activity: Activity::Accept(accept),
        } = &decision.state_changes[2]
        else {
            panic!("expected stored Accept activity");
        };
        ...
        let Effect::PlanDelivery(delivery) = &decision.effects[0];
        assert_eq!(
            delivery.inbox,
            iri("https://remote.example/users/bob/inbox")
        );
        assert!(matches!(delivery.activity, Activity::Accept(_)));
    }

    #[test]
    fn decide_received_follow_uses_shared_inbox_for_delivery() {
        let core = core();
        let follow = vocab::Follow::new(
            iri("https://remote.example/activities/follow/1"),
            vocab::Reference::id(iri("https://remote.example/users/bob")),
    ...
    #[test]
    fn decide_received_follow_is_idempotent_for_processed_activity() {
        let core = core();
        let follow = vocab::Follow::new(
            iri("https://remote.example/activities/follow/1"),
            vocab::Reference::id(iri("https://remote.example/users/bob")),
    ...
    #[test]
    fn decide_received_follow_does_not_add_existing_follower_again() {
        let core = core();
        let follow = vocab::Follow::new(
            iri("https://remote.example/activities/follow/1"),
            vocab::Reference::id(iri("https://remote.example/users/bob")),
    ...
    #[test]
    fn decide_received_follow_returns_missing_inbox_error() {
        let core = core();
        let follow = vocab::Follow::new(
            iri("https://remote.example/activities/follow/1"),
            vocab::Reference::id(iri("https://remote.example/users/bob")),
    ...
    #[test]
    fn decide_received_follow_ignores_non_accept_policy() {
        let core = core();
        let follow = vocab::Follow::new(
            iri("https://remote.example/activities/follow/1"),
            vocab::Reference::id(iri("https://remote.example/users/bob")),
